      ...
      <div className="flex w-full flex-col gap-3 xl:gap-4 lg:flex-row">
        <section className="obsera-panel-in obsera-surface flex min-h-0 flex-1 flex-col overflow-hidden transition-colors duration-200">
          ...
          <div className="flex flex-1 p-3 sm:p-5">
            <div
              className="relative min-h-[520px] w-full flex-1 overflow-hidden rounded-lg border border-[var(--obsera-border)] bg-[var(--obsera-surface-deep)] p-4 transition-colors duration-200"
            ...
            >
              ...
              <div className="absolute left-4 top-4 z-10 max-w-[calc(100%-2rem)] truncate rounded-md border border-[var(--obsera-border)] bg-[#0F172A]/92 px-3 py-2 text-xs text-[var(--obsera-text-soft)]">
                {selectedNode
                  ? selectedNode.label
                  : 'Dependency graph workspace'}
              </div>

              <div className="obsera-panel-in relative h-[460px] w-full pt-10 sm:h-[520px]">
                <ErrorBoundary
        ...
        <div className="obsera-panel-in w-full shrink-0 lg:w-[360px]">
          <ErrorBoundary
